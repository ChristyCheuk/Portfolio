...
After finalizing what would be included, I started working on the data visualizations. The participants provided a few recommendations on the design and the content, including changing colors and adding descriptions. Those helped to better convey the message. 
